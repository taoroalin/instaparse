...
(defn matching-look "Lookahead, i.e., &parser"
  [parser]
  {:tag :matching-look :parser parser})
...
(defn auto-whitespace-parser [parser ws-parser]
  (case (:tag parser)
    (:nt :epsilon) parser
    (:opt :plus :star :rep :look :matching-look :neg) (update-in parser [:parser] auto-whitespace-parser ws-parser)
